...
#### *Note: R version 3.3 was used here.* You will need to compile the packages/libraries that are used in https://github.com/alikhuseynov/registSurAuto3d/blob/master/pipeline_example.R
